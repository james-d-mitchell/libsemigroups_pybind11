...
from _libsemigroups_pybind11 import (
    ...
    to_knuth_bendix_RevRPOSet as _to_knuth_bendix_RevRPOSet,
    to_knuth_bendix_RevRPOTrie as _to_knuth_bendix_RevRPOTrie,
    ...
    to_knuth_bendix_string_RevRPOSet as _to_knuth_bendix_string_RevRPOSet,
    to_knuth_bendix_string_RevRPOTrie as _to_knuth_bendix_string_RevRPOTrie,
    ...
    to_knuth_bendix_word_RevRPOSet as _to_knuth_bendix_word_RevRPOSet,
    to_knuth_bendix_word_RevRPOTrie as _to_knuth_bendix_word_RevRPOTrie,
...
_RETURN_TYPE_TO_CONVERTER_FUNCTION = {
    ...
    (_KnuthBendix, "Set", _Order.lenlex): _to_knuth_bendix_LenLexSet,
    (_KnuthBendix, "Trie", _Order.lenlex): _to_knuth_bendix_LenLexTrie,
    ...
    (_KnuthBendix, str, "Set", _Order.lenlex): _to_knuth_bendix_string_LenLexSet,
    (_KnuthBendix, str, "Trie", _Order.lenlex): _to_knuth_bendix_string_LenLexTrie,
    (_KnuthBendix, "Set", _Order.rpo): _to_knuth_bendix_RPOSet,
    (_KnuthBendix, "Trie", _Order.rpo): _to_knuth_bendix_RPOTrie,
    (_KnuthBendix, list[int], "Set", _Order.rpo): _to_knuth_bendix_word_RPOSet,
    (_KnuthBendix, list[int], "Trie", _Order.rpo): _to_knuth_bendix_word_RPOTrie,
    (_KnuthBendix, str, "Set", _Order.rpo): _to_knuth_bendix_string_RPOSet,
    (_KnuthBendix, str, "Trie", _Order.rpo): _to_knuth_bendix_string_RPOTrie,
    (_KnuthBendix, "Set", _Order.rev_rpo): _to_knuth_bendix_RevRPOSet,
    (_KnuthBendix, "Trie", _Order.rev_rpo): _to_knuth_bendix_RevRPOTrie,
    (_KnuthBendix, list[int], "Set", _Order.rev_rpo): _to_knuth_bendix_word_RevRPOSet,
    (_KnuthBendix, list[int], "Trie", _Order.rev_rpo): _to_knuth_bendix_word_RevRPOTrie,
    (_KnuthBendix, str, "Set", _Order.rev_rpo): _to_knuth_bendix_string_RevRPOSet,
    (_KnuthBendix, str, "Trie", _Order.rev_rpo): _to_knuth_bendix_string_RevRPOTrie,
